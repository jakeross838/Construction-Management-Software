...
const leadNotificationsRoutes = require('./routes/lead-notifications');
const leadImportsRoutes = require('./routes/lead-imports');
...
const lienReleaseRoutes = require('./routes/lien-releases');
...
app.use('/api/lead-notifications', leadNotificationsRoutes);
...
app.use('/api/lien-releases', lienReleaseRoutes);
...
// Cost codes routes moved to server/routes/cost-codes.js

// Purchase orders routes moved to server/routes/purchase-orders.js
...
// Supports partial payments - payment_status: unpaid â†’ partial â†’ paid
...
app.patch('/api/invoices/:id', asyncHandler(async (req, res) => {
  ...
  if (updates.status && updates.status !== existing.status) {
    ...
    const statusTransitions = {
      ...
      // Send back from pm_approved: pm_approved â†’ needs_review (clear approval, record reason)
...
// Locks routes moved to server/routes/locks.js
...
// Realtime routes moved to server/routes/realtime.js
